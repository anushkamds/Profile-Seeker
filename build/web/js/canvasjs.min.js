...
(function () {
    ...
    function Aa(a) {
        a.roundRect = function (a, c, d, e, f, g, l, p) {
            l && (this.fillStyle = l);
    ...
    function ca(a, b, c) {
        if (v && ta) {
            ...
            a.width = b * Q;
            a.height = c * Q;
            ia !== da && (a.style.width = b + "px", a.style.height = c + "px", d.scale(Q, Q))
    ...
    function ea(a, b) {
        ...
        ca(c, a, b);
        v || "undefined" === typeof G_vmlCanvasManager || G_vmlCanvasManager.initElement(c);
        return c
    }
    ...
    function ua(a, b, c) {
        if (a && b && c) {
            ...
            f.target = "_blank";
            if (new Blob) {
                for (var g = a.replace(/^data:[a-z/]*;base64,/, ""), g = atob(g), l = new ArrayBuffer(g.length), p = new Uint8Array(l), h = 0; h < g.length; h++) p[h] = g.charCodeAt(h);
                b = new Blob([l], {
                    type: "image/" + b
                });
                try {
    ...
    function ja(a, b) {
        ja.parent.constructor.call(this, b);
        this.chart = a;
        this.canvas =
            a.canvas;
        this.ctx = this.chart.ctx
    ...
    function z(a, b, c, d) {
        ...
        if (this._options.stripLines && 0 < this._options.stripLines.length)
            for (this.stripLines = [], b = 0; b < this._options.stripLines.length; b++) this.stripLines.push(new ka(this.chart, this._options.stripLines[b], a.theme,
    ...
    function ka(a, b, c, d) {
        ka.parent.constructor.call(this, "StripLine", b, c);
    ...
    var v = !!document.createElement("canvas").getContext,
        ...
        xa = function () {
            ...
            return function (l, p, h) {
                ...
                "UTC:" === p.slice(0, 4) && (p = p.slice(4), q = !0);
                h = q ? "getUTC" : "get";
                var s = l[h + "Date"](),
                    u = l[h + "Day"](),
                    t = l[h + "Month"](),
                ...
                return h = p.replace(a, function (a) {
                    ...
                    case "YY":
                        return J(String(v).slice(-2), 2);
                    case "YYY":
                        return J(String(v).slice(-3), 3);
                    case "YYYY":
                        return J(v, 4);
                    case "h":
                        return E % 12 || 12;
                    ...
                    case "TT":
                        return 12 > E ? "AM" : "PM";
                    case "K":
                        return q ? "UTC" : (String(l).match(f) || [""]).pop().replace(g, "");
                    case "z":
        ...
        W = function (a, b, c) {
            ...
            for (var u = 0; l && u < l.length; u++)
                if (b = l[u], "." === b && 0 > p) p = u;
                    ...
                    if ("%" === b) g *= 100;
                        ...
                        p = u + b.length - 1;
                        continue
                    } else "E" !== b[0] && "e" !== b[0] || "0" !== b[b.length - 1] || (q = !0);
                    0 > p ? (h.push(b), "#" === b || "0" === b ? n++ : "," === b && r++) : (k.push(b), "#" !== b && "0" !==
                        b || m++)
                }
            q && (b = Math.floor(a), s = (0 === b ? "" : String(b)).length - n, g /= Math.pow(10, s));
            0 > p && (p = u);
            g = (a * g).toFixed(m);
            b = g.split(".");
            g = (b[0] + "").split("");
            a = (b[1] + "").split("");
            g && "0" === g[0] && g.shift();
            for (u = q = l = m = p = 0; 0 < h.length;)
                if (b = h.pop(), "#" === b || "0" === b)
                    if (p++, p === n) {
                        var t = g,
                            g = [];
                        if ("0" === b)
                            for (b = n - m - (t ? t.length : 0); 0 < b;) t.unshift("0"), b--;
                        for (; 0 < t.length;) c = t.pop() + c, u++, 0 === u % q && (l === r && 0 < t.length) && (c = f + c);
                        d && (c = "-" + c)
                    } else 0 < g.length ? (c = g.pop() + c, m++, u++) : "0" === b && (c = "0" + c, m++, u++), 0 === u % q && (l ===
                        r && 0 < g.length) && (c = f + c);
            else "E" !== b[0] && "e" !== b[0] || "0" !== b[b.length - 1] || !/[eE][+-]*[0]+/.test(b) ? "," === b ? (l++, q = u, u = 0, 0 < g.length && (c = f + c)) : c = 1 < b.length && ('"' === b[0] && '"' === b[b.length - 1] || "'" === b[0] && "'" === b[b.length - 1]) ? b.slice(1, b.length - 1) + c : b + c : (b = 0 > s ? b.replace("+", "").replace("-", "") : b.replace("-", ""), c += b.replace(/[0]+/, function (a) {
                return J(s, a.length)
            }));
            d = "";
    ...
    w.prototype._updateOptions = function () {
        ...
        this.exportEnabled && (v && !this._menuButton) && (this._menuButton = document.createElement("button"), L(this, this._menuButton, "menu"), this._toolBar.appendChild(this._menuButton), F(this._menuButton, "click", function () {
        ...
        var b = this.updateOption("creditText"),
            c = this.updateOption("creditHref");
        if (0 === this.renderCount || b || c) this._creditLink.setAttribute("href", this.creditHref), this._creditLink.innerHTML = this.creditText;
    ...
    w.prototype._initialize = function () {
        ...
        for (var a = 0, b = 0; b < this._options.data.length; b++)
            if (a++, !this._options.data[b].type || 0 <= w._supportedChartTypes.indexOf(this._options.data[b].type)) {
                var c = new O(this, this._options.data[b], this.theme, a - 1, ++this._eventManager.lastObjectId);
                null === c.name && (c.name =
                    "DataSeries " + a);
                null === c.color ? 1 < this._options.data.length ? (c._colorSet = [this._selectedColorSet[c.index % this._selectedColorSet.length]], c.color = this._selectedColorSet[c.index % this._selectedColorSet.length]) : c._colorSet = "line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type || "rangeArea" === c.type || "rangeSplineArea" === c.type || "candlestick" === c.type || "ohlc" === c.type ? [this._selectedColorSet[0]] :
                    this._selectedColorSet : c._colorSet = [c.color];
                ...
                var d = c.axisPlacement,
                    e;
                "normal" === d ? "xySwapped" === this.plotInfo.axisPlacement ? e = 'You cannot combine "' + c.type + '" with bar chart' : "none" === this.plotInfo.axisPlacement ? e = 'You cannot combine "' + c.type +
                    '" with pie chart' : null === this.plotInfo.axisPlacement && (this.plotInfo.axisPlacement = "normal") : "xySwapped" === d ? "normal" === this.plotInfo.axisPlacement ? e = 'You cannot combine "' + c.type + '" with line, area, column or pie chart' : "none" === this.plotInfo.axisPlacement ? e = 'You cannot combine "' + c.type + '" with pie chart' : null === this.plotInfo.axisPlacement && (this.plotInfo.axisPlacement = "xySwapped") : "none" == d && ("normal" === this.plotInfo.axisPlacement ? e = 'You cannot combine "' + c.type + '" with line, area, column or bar chart' :
                        "xySwapped" === this.plotInfo.axisPlacement ? e = 'You cannot combine "' + c.type + '" with bar chart' : null === this.plotInfo.axisPlacement && (this.plotInfo.axisPlacement = "none"));
                if (e && window.console) {
    ...
    w.prototype._processMultiseriesPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = 0; g < a.dataSeriesIndexes.length; g++) {
                var l = this.data[a.dataSeriesIndexes[g]],
                    p = 0,
                    h = !1,
                    k = !1;
                if ("normal" ===
                    l.axisPlacement || "xySwapped" === l.axisPlacement) var n = this.sessionVariables.axisX.internalMinimum ? this.sessionVariables.axisX.internalMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity,
                ...
                if (l.dataPoints[p].x && l.dataPoints[p].x.getTime || "dateTime" === l.xValueType) f = !0;
                for (p = 0; p < l.dataPoints.length; p++) {
                    "undefined" ===
                        typeof l.dataPoints[p].x && (l.dataPoints[p].x = p);
                    l.dataPoints[p].x.getTime ? (f = !0, d = l.dataPoints[p].x.getTime()) : d = l.dataPoints[p].x;
                    e = l.dataPoints[p].y;
                    d < c.min && (c.min = d);
                    d > c.max && (c.max = d);
                    e < b.min && (b.min = e);
    ...
    w.prototype._processStackedPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = [], l = [], p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement) var r = this.sessionVariables.axisX.internalMinimum ?
                    ...
                    q = this.sessionVariables.axisX.internalMaximum ? this.sessionVariables.axisX.internalMaximum : this._options.axisX && this._options.axisX.maximum ? this._options.axisX.maximum : Infinity;
    ...
    w.prototype._processStacked100PlotUnit = function (a) {
        if (a.dataSeriesIndexes &&
            ...
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = !1, l = !1, p = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                var k = this.data[a.dataSeriesIndexes[h]],
                    n = 0,
                    m = !1,
                    r = !1;
                if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var q = this.sessionVariables.axisX.internalMinimum ? this.sessionVariables.axisX.internalMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity,
                ...
                for (n = 0; n < k.dataPoints.length; n++) {
                    ...
                    if (!(d < q) || m) {
                        ...
                        if (d > s && !r) r = !0;
                        else if (d > s && r) continue;
                        k.dataPoints[n].label && (a.axisX.labels[d] = k.dataPoints[n].label);
                        d < c.viewPortMin && (c.viewPortMin = d);
                        d > c.viewPortMax && (c.viewPortMax = d);
                        null !== e && (a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(e), 0 <= e ? g = !0 : l = !0, p[d] = p[d] ? p[d] + Math.abs(e) : Math.abs(e))
                    }
                }
    ...
    w.prototype._processMultiYPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f, g, l = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                var h = this.data[a.dataSeriesIndexes[p]],
                    k = 0,
                    n = !1,
                    m = !1;
    ...
    w.prototype.getObjectAtXY = function (a, b, c) {
        ...
        else if (v) d = ra(a, b, this._eventManager.ghostCtx);
        else
    ...
    w.prototype._mouseEventHandler = function (a) {
        if (this.interactivityEnabled) {
            ...
            if (!e) {
                if (w.capturedEventParam) d = w.capturedEventParam, "mouseup" === c && (w.capturedEventParam =
    ...
    w.prototype._plotAreaMouseMove = function (a, b) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if (2 < Math.abs(c) && (this.panEnabled || this.zoomEnabled))
                ...
                } else this.zoomEnabled && (c = this.plotArea, this.resetOverlayedCanvas(), d = this.overlaidCanvasCtx.globalAlpha, this.overlaidCanvasCtx.globalAlpha =
    ...
    w.prototype.renderIndexLabels =
        function () {
            ...
            for (var b = this.plotArea, c = 0; c < this._indexLabels.length; c++) {
                ...
                var l = this.replaceKeywordsWithValue(R("indexLabel", d.dataPoint, d.dataSeries), d.dataPoint, d.dataSeries, null, d.indexKeyword),
                    p = a.measureText(l).width,
                    h = R("indexLabelFontSize", d.dataPoint, d.dataSeries),
                    k = R("indexLabelPlacement", d.dataPoint, d.dataSeries),
                    n = R("indexLabelOrientation", d.dataPoint, d.dataSeries),
                    m = g = 0,
                    r = 0,
                    q = 0,
                    s = 0,
                    u = 0,
                    t = d.direction;
                d.point.x < b.x1 || (d.point.x > b.x2 || d.point.y < b.y1 || d.point.y > b.y2) || ("column" === d.chartType || "stackedColumn" === d.chartType || "stackedColumn100" === d.chartType || "bar" === d.chartType || "stackedBar" === d.chartType || "stackedBar100" === d.chartType || "candlestick" === d.chartType || "ohlc" === d.chartType || "rangeColumn" === d.chartType || "rangeBar" === d.chartType ? (u = 5, Math.abs(d.bounds.x1, d.bounds.x2), Math.abs(d.bounds.y1, d.bounds.y2),
                ...
                if (0 < l.length) {
                    for (var r = !1, k = 0; k < l.length; k++)
                        if (n = l[k].x.getTime ? l[k].x.getTime() : l[k].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof l[k].y) 0 < k && (b.stroke(), v && c.stroke()), r = !0;
                            else {
                                ...
                                h || r ? (b.beginPath(), b.moveTo(n, m), v && (c.beginPath(), c.moveTo(n, m)), r = h = !1) : (b.lineTo(n, m), v && c.lineTo(n, m), 0 == k % 500 && (b.stroke(), b.beginPath(), b.moveTo(n, m), v && (c.stroke(), c.beginPath(), c.moveTo(n, m))));
                    ...
                    for (var r = !1, k = 0; k < l.length; k++)
                        if (n =
                            ...
                            if ("number" !== typeof l[k].y) 0 < k && (b.stroke(), v && c.stroke()), r = !0;
                                ...
                                h || r ? (b.beginPath(), b.moveTo(n, m), v && (c.beginPath(), c.moveTo(n, m)), r = h = !1) : (b.lineTo(n, q), v && c.lineTo(n, q), b.lineTo(n, m), v && c.lineTo(n, m), 0 == k % 500 && (b.stroke(), b.beginPath(), b.moveTo(n, m), v && (c.stroke(), c.beginPath(), c.moveTo(n, m))));
                                if (0 < l[k].markerSize || 0 < g.markerSize) q = g.getMarkerProperties(k, n, m, b), d.push(q), s = A(s), v && d.push({
                                    x: n,
                                    y: m,
                                    ctx: c,
                                    type: q.type,
        ...
        function b(a) {
            ...
            if (0 < a.length) {
                ...
                for (var b = 0; b < a.length - 3; b += 3) c.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y), v && d.bezierCurveTo(a[b +
                    1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y), 0 < b && 0 === b % 3E3 && (c.stroke(), c.beginPath(), c.moveTo(a[b + 3].x, a[b + 3].y), v && (d.stroke(), d.beginPath(), d.moveTo(a[b + 3].x, a[b + 3].y)));
                c.stroke();
                v && d.stroke()
            }
        }
            ...
            for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < p.length)
                    for (k = 0; k < p.length; k++)
                        if (n = p[k].getTime ? p[k].x.getTime() : p[k].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof p[k].y) 0 < k && (b(r), r = []);
                            else {
                                ...
                                m = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (p[k].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                var q = l.dataPointIds[k];
                                this._eventManager.objectMap[q] = {
                                    id: q,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: g,
                                ...
                                if (0 < p[k].markerSize || 0 < l.markerSize) {
    ...
    var D = function (a, b, c, d, e, f, g, l, p, h, k, n, m) {
        ...
        a.restore();
        !0 === p && (a.save(), a.beginPath(), a.moveTo(b, c), a.lineTo(b + r, c + r), a.lineTo(d - r, c + r), a.lineTo(d, c), a.closePath(), g = a.createLinearGradient((d + b) / 2, c + r, (d + b) / 2, c), g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, .4)"), a.fillStyle = g, a.fill(), a.restore());
    ...
    w.prototype.renderColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                d = this.plotArea,
                e = 0,
                f, g, l, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0,
                e = Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) <<
                0,
                h = a.axisX.dataInfo.minDiff,
                k = 0.9 * (d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(h) / a.plotType.totalDataSeries) << 0;
            ...
            b.rect(d.x1, d.y1, d.width, d.height);
            b.clip();
            v && (this._eventManager.ghostCtx.rect(d.x1, d.y1, d.width, d.height), this._eventManager.ghostCtx.clip());
                ...
                if (0 < m.length)
                    for (var r = 5 < k &&
                        ...
                        if (m[e].getTime ? l = m[e].x.getTime() : l = m[e].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                            ...
                            D(b, f, g, q, s, c, 0, null, r && 0 <= m[e].y, 0 > m[e].y && r, !1, !1, n.fillOpacity);
                            c = n.dataPointIds[e];
                            ...
                            c = A(c);
                            v && D(this._eventManager.ghostCtx, f, g, q, s, c, 0, null, !1, !1, !1, !1);
    ...
    w.prototype.renderStackedColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                f = [],
                g = 0,
                l, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0,
                g = 0.15 * this.width << 0,
                h = a.axisX.dataInfo.minDiff,
                k = 0.9 * (d.width /
                ...
                if (0 < r.length) {
                    ...
                    for (g = 0; g < r.length; g++)
                        if (c = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[g].y) {
                            ...
                            var s = d - a.plotType.plotUnits.length * k / 2 + a.index * k << 0,
                                u = s + k << 0,
                                t;
                            if (0 <= r[g].y) {
                                var x =
                                ...
                                t = p - x;
                                e[c] = x + (t - l)
                            } else x = f[c] ? f[c] : 0, t = l + x, l = p + x, f[c] = x + (t - l);
                            c = r[g].color ? r[g].color : m._colorSet[g % m._colorSet.length];
                            D(b, s, l, u, t, c, 0, null, q && 0 <= r[g].y, 0 > r[g].y && q, !1, !1, m.fillOpacity);
                            c = m.dataPointIds[g];
                            this._eventManager.objectMap[c] = {
                                id: c,
                                objectType: "dataPoint",
                            ...
                            c = A(c);
                            v && D(this._eventManager.ghostCtx, s, l, u, t, c, 0, null, !1, !1, !1, !1);
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var n = a.dataSeriesIndexes[h],
                    ...
                    r = m.dataPoints;
                if (0 < r.length)
                    for (var q = 5 < k && m.bevelEnabled ? !0 : !1, g = 0; g < r.length; g++)
                        if (c =
    ...
    w.prototype.renderBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                e = 0,
                f, g, l, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0,
                e = Math.min(0.15 * this.height, 0.9 * (this.plotArea.height /
                    a.plotType.totalDataSeries)) << 0,
                h = a.axisX.dataInfo.minDiff,
                k = 0.9 * (d.height / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(h) / a.plotType.totalDataSeries) << 0;
            k > e ? k = e : Infinity === h ? k = e : 1 > k && (k = 1);
            b.save();
            v && this._eventManager.ghostCtx.save();
            b.beginPath();
                ...
                if (0 < m.length) {
                    ...
                    for (e = 0; e < m.length; e++)
                        if (m[e].getTime ? l = m[e].x.getTime() : l = m[e].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                            ...
                            0 <= m[e].y ? s = p : (s = f, f = p);
                            c = m[e].color ? m[e].color : n._colorSet[e % n._colorSet.length];
                            D(b, s, g, f, q, c, 0, null, r, !1, !1, !1, n.fillOpacity);
                            c = n.dataPointIds[e];
                            this._eventManager.objectMap[c] = {
                                id: c,
                                objectType: "dataPoint",
                            ...
                            c = A(c);
                            v && D(this._eventManager.ghostCtx, s, g, f, q, c, 0, null, !1, !1, !1, !1);
    ...
    w.prototype.renderStackedBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                g = 0.15 * this.width << 0,
                h = a.axisX.dataInfo.minDiff,
                k = 0.9 * (d.height / Math.abs(a.axisX.maximum -
                    ...
                    for (g = 0; g < r.length; g++)
                        if (c =
                            ...
                            if (0 <= r[g].y) {
                                ...
                                l += x;
                                e[c] = x + (l - t)
                            } else x = f[c] ? f[c] : 0, t = l - x, l = p - x, f[c] = x + (l - t);
                            c = r[g].color ? r[g].color : m._colorSet[g % m._colorSet.length];
                            D(b, t, s, l, u, c, 0, null, q, !1, !1, !1, m.fillOpacity);
                            c = m.dataPointIds[g];
                            this._eventManager.objectMap[c] = {
                                id: c,
                                objectType: "dataPoint",
                            ...
                            c = A(c);
                            v && D(this._eventManager.ghostCtx, t, s, l, u, c, 0, null, !1, !1, !1, !1);
                            this._indexLabels.push({
    ...
    w.prototype.renderStackedBar100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                g = 0.15 * this.width << 0,
                h = a.axisX.dataInfo.minDiff,
                k = 0.9 * (d.height / Math.abs(a.axisX.maximum - a.axisX.minimum) *
    ...
    w.prototype.renderArea = function (a) {
        function b() {
            x && (0 < h.lineThickness && c.stroke(), 0 >= a.axisY.minimum && 0 <= a.axisY.maximum ? t = u : 0 > a.axisY.maximum ? t = f.y1 : 0 < a.axisY.minimum && (t = e.y2), c.lineTo(r, t), c.lineTo(x.x, t), c.closePath(), c.globalAlpha = h.fillOpacity, c.fill(), c.globalAlpha = 1, v && (d.lineTo(r, t), d.lineTo(x.x, t), d.closePath(), d.fill()), c.beginPath(),
                c.moveTo(r, q), d.beginPath(), d.moveTo(r, q), x = {
                    x: r,
                    y: q
                })
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                var g = [],
                    n = !0,
                    m = 0,
                    r, q, s, u = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) + 0.5 << 0,
                    t, x = null;
                if (0 < k.length) {
                    ...
                    for (var V = !0; m < k.length; m++)
                        if (s = k[m].x.getTime ? k[m].x.getTime() : k[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof k[m].y) b(),
                                ...
                                q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (k[m].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                n || V ? (c.beginPath(), c.moveTo(r, q), x = {
                                    x: r,
                                    y: q
                                }, v && (d.beginPath(), d.moveTo(r, q)), V = n = !1) : (c.lineTo(r, q), v && d.lineTo(r, q), 0 == m % 250 && b());
                                ...
                                0 !== k[m].markerSize && (0 < k[m].markerSize || 0 < h.markerSize) && (s = h.getMarkerProperties(m, r, q, c), g.push(s), B = A(B), v && g.push({
                                    x: r,
                                    y: q,
                                    ctx: d,
                                    type: s.type,
        ...
        function (a) {
            function b() {
                ...
                if (0 < b.length) {
                    ...
                    for (var g = 0; g < b.length - 3; g += 3) c.bezierCurveTo(b[g + 1].x, b[g + 1].y, b[g + 2].x, b[g + 2].y, b[g + 3].x, b[g + 3].y), v && d.bezierCurveTo(b[g + 1].x, b[g + 1].y, b[g + 2].x, b[g + 2].y, b[g + 3].x, b[g + 3].y);
                    0 < h.lineThickness && c.stroke();
                    0 >= a.axisY.minimum && 0 <= a.axisY.maximum ? s = q : 0 > a.axisY.maximum ? s = f.y1 : 0 < a.axisY.minimum && (s = e.y2);
                    u = {
                        x: b[0].x,
                        y: b[0].y
                    };
                    ...
                    c.fill();
                    c.globalAlpha = 1;
                    v && (d.lineTo(b[b.length - 1].x, s), d.lineTo(u.x, s), d.closePath(), d.fill())
                }
            }
            var c = this.plotArea.ctx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    var g = [],
                        n = 0,
                        m, r, q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) + 0.5 << 0,
                        s, u = null,
                        t = [];
                    if (0 < k.length) {
                        ...
                        for (c.lineWidth = h.lineThickness; n < k.length; n++)
                            if (m = k[n].x.getTime ? k[n].x.getTime() : k[n].x, !(m < a.axisX.dataInfo.viewPortMin ||
                                ...
                                if ("number" !== typeof k[n].y) 0 < n && (b(), t = []);
                                else {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                var g = [],
                    n = !0,
                    m = 0,
                    r, q, s, u = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) +
                    0.5 << 0,
                    t, x = null,
                    E = !1;
                if (0 < k.length) {
                    ...
                    for (c.lineWidth = h.lineThickness; m < k.length; m++)
                        if (s = k[m].x.getTime ? k[m].x.getTime() : k[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax)) {
                            var B = q;
                            "number" !== typeof k[m].y ? (b(), E = !0) : (r = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (s - a.axisX.conversionParameters.minimum) + 0.5 << 0, q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit *
                                (k[m].y - a.axisY.conversionParameters.minimum) + 0.5 << 0, n || E ? (c.beginPath(), c.moveTo(r, q), x = {
                                    x: r,
                                    y: q
                                }, v && (d.beginPath(), d.moveTo(r, q)), E = n = !1) : (c.lineTo(r, B), v && d.lineTo(r, B), c.lineTo(r, q), v && d.lineTo(r, q), 0 == m % 250 && b()), B = h.dataPointIds[m], this._eventManager.objectMap[B] = {
                                    id: B,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: p,
                                    dataPointIndex: m,
    ...
    w.prototype.renderStackedArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                g = [],
                l = 0,
                p, h, k, n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit *
            ...
            b.clip();
            v && (m.beginPath(), m.rect(e.x1, e.y1, e.width, e.height), m.clip());
            xValuePresent = [];
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                var r = a.dataSeriesIndexes[e],
                    ...
                    s = q.dataPoints;
                q.dataPointIndexes = [];
                for (l = 0; l < s.length; l++) r = s[l].x.getTime ? s[l].x.getTime() : s[l].x, q.dataPointIndexes[r] = l, xValuePresent[r] || (g.push(r), xValuePresent[r] = !0);
                g.sort(pa)
            }
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                var r = a.dataSeriesIndexes[e],
                ...
                if (0 < g.length) {
                    ...
                    for (l = 0; l < g.length; l++) {
                        k = g[l];
                        var x = null,
                            x = 0 <= q.dataPointIndexes[k] ? s[q.dataPointIndexes[k]] : {
                                x: k,
                                y: 0
                            };
                        if (!(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" ===
                            typeof x.y) {
                            p = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (k - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                            ...
                            f[k] = n - h;
                            if (u) b.beginPath(), b.moveTo(p, h), v && (m.beginPath(), m.moveTo(p, h)), u = !1;
                            else if (b.lineTo(p, h), v && m.lineTo(p, h), 0 == l % 250) {
                                for (0 < q.lineThickness && b.stroke(); 0 < t.length;) {
                                    var w =
                                        t.pop();
                                    b.lineTo(w.x, w.y);
                                    v && m.lineTo(w.x, w.y)
                                ...
                                b.beginPath();
                                b.moveTo(p, h);
                                v && (m.closePath(), m.fill(), m.beginPath(), m.moveTo(p, h));
                                t.push({
                                    x: p,
                                    y: n - E
                                })
                            }
                            if (0 <= q.dataPointIndexes[k]) {
                                var B = q.dataPointIds[q.dataPointIndexes[k]];
                                this._eventManager.objectMap[B] = {
                                    id: B,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: r,
                                    dataPointIndex: q.dataPointIndexes[k],
                                    x1: p,
                                    y1: h
                                }
                            }
                            0 <= q.dataPointIndexes[k] && 0 !== x.markerSize && (0 < x.markerSize || 0 < q.markerSize) && (k = q.getMarkerProperties(l,
                                p, h, b), d.push(k), markerColor = A(B), v && d.push({
                                x: p,
                                y: h,
                                ctx: m,
                                type: k.type,
                            ...
                            (x.indexLabel || q.indexLabel) && this._indexLabels.push({
                    ...
                    for (0 < q.lineThickness && b.stroke(); 0 < t.length;) w = t.pop(), b.lineTo(w.x, w.y), v && m.lineTo(w.x, w.y);
                    b.closePath();
                    b.globalAlpha = q.fillOpacity;
                    b.fill();
                    b.globalAlpha = 1;
    ...
    w.prototype.renderStackedArea100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                g = [],
                l = 0,
                p, h, k, n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0,
                m = 0.15 * this.width << 0,
                r = a.axisX.dataInfo.minDiff,
                r = 0.9 * d.width / Math.abs(a.axisX.maximum -
                    a.axisX.minimum) * Math.abs(r) << 0,
                q = this._eventManager.ghostCtx;
            b.save();
            v && q.save();
            b.beginPath();
            b.rect(d.x1, d.y1, d.width, d.height);
            b.clip();
            v && (q.beginPath(), q.rect(d.x1, d.y1, d.width, d.height), q.clip());
            xValuePresent = [];
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                var s = a.dataSeriesIndexes[d],
                    ...
                    t = u.dataPoints;
                u.dataPointIndexes = [];
                for (l = 0; l < t.length; l++) s = t[l].x.getTime ? t[l].x.getTime() : t[l].x, u.dataPointIndexes[s] = l, xValuePresent[s] || (g.push(s), xValuePresent[s] = !0);
                g.sort(pa)
            }
            for (d = 0; d <
                ...
                var E = [];
                if (0 < g.length) {
                    c = u._colorSet[l % u._colorSet.length];
                    b.fillStyle = c;
                    b.strokeStyle = c;
                    ...
                    for (l = 0; l < g.length; l++) {
                        k = g[l];
                        var w = null,
                            w = 0 <= u.dataPointIndexes[k] ? t[u.dataPointIndexes[k]] : {
                                x: k,
                                y: 0
                            };
                        if (!(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) &&
                            ...
                            f[k] = n - h;
                            if (x) b.beginPath(), b.moveTo(p, h), v && (q.beginPath(), q.moveTo(p, h)), x = !1;
                            else if (b.lineTo(p, h), v && q.lineTo(p,
                                h), 0 == l % 250) {
                                for (0 < u.lineThickness && b.stroke(); 0 < E.length;) {
                                    var G = E.pop();
                                    b.lineTo(G.x, G.y);
                                    v && q.lineTo(G.x, G.y)
                                }
                                ...
                                b.beginPath();
                                b.moveTo(p, h);
                                v && (q.closePath(), q.fill(), q.beginPath(), q.moveTo(p, h));
                                E.push({
                                    x: p,
                                    y: n - B
                                })
                            }
                            if (0 <= u.dataPointIndexes[k]) {
                                var y = u.dataPointIds[u.dataPointIndexes[k]];
                                this._eventManager.objectMap[y] = {
                                    id: y,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: s,
                                    dataPointIndex: u.dataPointIndexes[k],
                                    x1: p,
                                    y1: h
                                }
                            }
                            0 <= u.dataPointIndexes[k] &&
                                0 !== w.markerSize && (0 < w.markerSize || 0 < u.markerSize) && (k = u.getMarkerProperties(l, p, h, b), e.push(k), markerColor = A(y), v && e.push({
                                    x: p,
                                    y: h,
                                    ctx: q,
                                    type: k.type,
                            ...
                            (w.indexLabel || u.indexLabel) && this._indexLabels.push({
                    ...
                    for (0 < u.lineThickness && b.stroke(); 0 < E.length;) G = E.pop(), b.lineTo(G.x, G.y), v && q.lineTo(G.x, G.y);
                    b.closePath();
                    b.globalAlpha = u.fillOpacity;
                    b.fill();
                    b.globalAlpha = 1;
    ...
    w.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= c)) {
            ...
            b.clip();
            v && (this._eventManager.ghostCtx.rect(d.x1, d.y1, d.width, d.height), this._eventManager.ghostCtx.clip());
            for (var p = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
                for (var n = a.dataSeriesIndexes[k], m = this.data[n], r = m.dataPoints, q = 0, e = 0; e < r.length; e++) f = r[e].getTime ? f = r[e].x.getTime() : f = r[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof r[e].z || (q = r[e].z, q > p && (p = q), q < h && (h = q));
                ...
                if (n = a.dataSeriesIndexes[k], m = this.data[n], r = m.dataPoints, 1 == r.length && (c = l), 1 > c ? c = 1 : c > l && (c = l), 0 < r.length)
                    for (b.strokeStyle = "#4572A7 ", e = 0; e < r.length; e++)
                        if (f = r[e].getTime ? f = r[e].x.getTime() : f = r[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[e].y) {
                            ...
                            var q = r[e].z,
                                u = 2 * Math.max(Math.sqrt((p === h ? d / 2 : s + (d - s) / (p - h) * (q - h)) / Math.PI) << 0, 1),
                                q = m.getMarkerProperties(e, b);
                            q.size = u;
                            b.globalAlpha = m.fillOpacity;
                            I.drawMarker(f, g, b, q.type, q.size, q.color, q.borderColor, q.borderThickness);
                            b.globalAlpha = 1;
                            ...
                            u = A(t);
                            v && I.drawMarker(f, g, this._eventManager.ghostCtx, q.type, q.size, u, u, q.borderThickness);
                ...
                if (0 < n.length) {
                    ...
                    for (var m =
                        ...
                        if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                            ...
                            var q = k.getMarkerProperties(e, f, g, b);
                            b.globalAlpha = k.fillOpacity;
                            I.drawMarker(q.x,
                                q.y, q.ctx, q.type, q.size, q.color, q.color, q.thickness);
                            b.globalAlpha = 1;
                            Math.sqrt((m - f) * (m - f) + (r - g) * (r - g)) < Math.min(q.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (m = k.dataPointIds[e], this._eventManager.objectMap[m] = {
                                id: m,
                                objectType: "dataPoint",
                                dataSeriesIndex: h,
                                dataPointIndex: e,
                                x1: f,
                                y1: g
                            }, m = A(m), v && I.drawMarker(q.x, q.y, this._eventManager.ghostCtx, q.type, q.size, m, m, q.borderThickness), (n[e].indexLabel || k.indexLabel) && this._indexLabels.push({
                                chartType: "scatter",
                                dataPoint: n[e],
                                dataSeries: k,
                                point: {
    ...
    w.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null,
                d = this.plotArea,
                e = 0,
                f, g, l, p, h, k, e = 0.015 * this.width;
            ...
            b.rect(d.x1, d.y1,
                d.width, d.height);
            b.clip();
            v && (c.rect(d.x1, d.y1, d.width, d.height), c.clip());
            for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                var r = a.dataSeriesIndexes[m],
                    q = this.data[r],
                    s = q.dataPoints;
                if (0 < s.length)
                    for (var u = 5 < n && q.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++)
                        if (s[e].getTime ? k = s[e].x.getTime() : k = s[e].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== s[e].y && s[e].y.length && "number" === typeof s[e].y[0] && "number" === typeof s[e].y[1] && "number" === typeof s[e].y[2] && "number" === typeof s[e].y[3]) {
                            ...
                            p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (s[e].y[2] -
                            ...
                            var t = f - n / 2 << 0,
                                x = t + n << 0,
                                d = s[e].color ? s[e].color : q._colorSet[0],
                            ...
                            "candlestick" === q.type ? (b.moveTo(f - w, l), b.lineTo(f - w, Math.min(g, h)), b.stroke(), b.moveTo(f - w, Math.max(g, h)), b.lineTo(f - w, p), b.stroke(), D(b, t, Math.min(g, h), x, Math.max(g, h), s[e].y[0] <= s[e].y[3] ? q.risingColor : d, E, d, u, u, !1, !1, q.fillOpacity), v && (d = A(B), c.strokeStyle = d, c.moveTo(f - w, l), c.lineTo(f - w, Math.min(g, h)), c.stroke(), c.moveTo(f - w, Math.max(g, h)), c.lineTo(f - w, p), c.stroke(), D(c, t, Math.min(g, h), x, Math.max(g, h), d, 0, null, !1, !1, !1, !1))) : "ohlc" === q.type && (b.moveTo(f -
                                w, l), b.lineTo(f - w, p), b.stroke(), b.beginPath(), b.moveTo(f, g), b.lineTo(t, g), b.stroke(), b.beginPath(), b.moveTo(f, h), b.lineTo(x, h), b.stroke(), v && (d = A(B), c.strokeStyle = d, c.moveTo(f - w, l), c.lineTo(f - w, p), c.stroke(), c.beginPath(), c.moveTo(f, g), c.lineTo(t, g), c.stroke(), c.beginPath(), c.moveTo(f, h), c.lineTo(x, h), c.stroke()));
                            (s[e].indexLabel || q.indexLabel) && this._indexLabels.push({
                                chartType: q.type,
                                dataPoint: s[e],
                                dataSeries: q,
                                point: {
    ...
    w.prototype.renderRangeColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.rect(d.x1, d.y1, d.width, d.height);
            b.clip();
            v && (this._eventManager.ghostCtx.rect(d.x1,
                ...
                if (0 < n.length)
                    for (var m = 5 < l && k.bevelEnabled ? !0 : !1, e = 0; e < n.length; e++)
                        if (n[e].getTime ? g = n[e].x.getTime() : g = n[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== n[e].y && n[e].y.length && "number" === typeof n[e].y[0] && "number" === typeof n[e].y[1]) {
                            ...
                            var r = c - a.plotType.totalDataSeries * l / 2 + (a.previousDataSeriesCount + p) * l << 0,
                                q = r + l << 0,
                                c = n[e].color ? n[e].color : k._colorSet[e % k._colorSet.length];
                            if (d > f) {
                                var s = d,
                                    d = f;
                                f = s
                            ...
                            D(b, r, d, q, f, c, 0, c, m, m, !1, !1, k.fillOpacity);
                            c = A(s);
                            v && D(this._eventManager.ghostCtx, r, d, q, f, c, 0, null, !1, !1, !1, !1);
    ...
    w.prototype.renderRangeBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                d = this.plotArea,
                e = 0,
                f, g, l, e = Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0;
            f = a.axisX.dataInfo.minDiff;
            var p =
                ...
                if (0 < m.length) {
                    ...
                    for (e = 0; e < m.length; e++)
                        if (m[e].getTime ? l = m[e].x.getTime() : l = m[e].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" === typeof m[e].y[1]) {
                            ...
                            d > f && (c = d, d = f, f = c);
                            c = m[e].color ? m[e].color : n._colorSet[e % n._colorSet.length];
                            D(b, d, g, f, q, c, 0, null, r, !1, !1, !1, n.fillOpacity);
                            c = n.dataPointIds[e];
                            this._eventManager.objectMap[c] = {
                                id: c,
                                objectType: "dataPoint",
                            ...
                            c = A(c);
                            v && D(this._eventManager.ghostCtx,
                                d, g, f, q, c, 0, null, !1, !1, !1, !1);
    ...
    w.prototype.renderRangeArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            c.clip();
            v && (d.beginPath(), d.rect(f.x1, f.y1, f.width, f.height), d.clip());
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                var g = [],
                    l = a.dataSeriesIndexes[f],
                    p = this.data[l],
                    h = p.dataPoints,
                    e = p.id;
                ...
                var e = [],
                    ...
                    m, r, q, s, u = null;
                if (0 < h.length) {
                    var t = p._colorSet[n % p._colorSet.length];
                    c.fillStyle = t;
                    c.strokeStyle = t;
                    ...
                    for (var x = !0; n < h.length; n++)
                        if (s = h[n].x.getTime ? h[n].x.getTime() : h[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))
                            if (null !== h[n].y && h[n].y.length && "number" === typeof h[n].y[0] && "number" === typeof h[n].y[1]) {
                                ...
                                q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (h[n].y[1] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                k || x ? (c.beginPath(), c.moveTo(m, r), u = {
                                    x: m,
                                    y: r
                                }, g = [], g.push({
                                    x: m,
                                    y: q
                                }), v && (d.beginPath(), d.moveTo(m, r)), x = k = !1) : (c.lineTo(m, r), g.push({
                                    x: m,
                                    y: q
                                }), v && d.lineTo(m, r), 0 == n % 250 && b());
                                s = p.dataPointIds[n];
                                this._eventManager.objectMap[s] = {
                                    id: s,
                                    objectType: "dataPoint",
                                ...
                                if (0 !== h[n].markerSize && (0 < h[n].markerSize || 0 < p.markerSize)) {
                                    ...
                                    w = p.getMarkerProperties(n, m, r, c);
                                    e.push(w);
                                    y = A(s);
                                    v && e.push({
                                        x: m,
                                ...
                                if (h[n].indexLabel || p.indexLabel) this._indexLabels.push({
                                    chartType: "rangeArea",
                                    dataPoint: h[n],
                                    dataSeries: p,
                                    indexKeyword: 0,
        ...
        function b() {
            ...
            if (0 < a.length) {
                ...
                v && (d.beginPath(), d.moveTo(a[0].x,
                    a[0].y));
                for (var b = 0; b < a.length - 3; b += 3) c.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y), v && d.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y);
                0 < l.lineThickness && c.stroke();
                a = fa(q, 2);
                c.lineTo(q[q.length - 1].x, q[q.length - 1].y);
                for (b = a.length - 1; 2 < b; b -= 3) c.bezierCurveTo(a[b - 1].x, a[b - 1].y, a[b - 2].x, a[b - 2].y, a[b - 3].x, a[b - 3].y), v && d.bezierCurveTo(a[b - 1].x, a[b - 1].y, a[b - 2].x, a[b - 2].y, a[b - 3].x, a[b - 3].y);
                c.closePath();
                ...
                if (0 < l.lineThickness) {
                    c.beginPath();
                    c.moveTo(q[q.length - 1].x, q[q.length - 1].y);
                    for (b = a.length - 1; 2 < b; b -= 3) c.bezierCurveTo(a[b - 1].x, a[b - 1].y, a[b - 2].x, a[b - 2].y, a[b - 3].x, a[b - 3].y), v && d.bezierCurveTo(a[b - 1].x, a[b - 1].y, a[b - 2].x, a[b - 2].y, a[b - 3].x, a[b - 3].y);
                    c.stroke()
                }
                c.beginPath();
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < p.length) {
                    ...
                    c.fillStyle = color;
                    c.strokeStyle = color;
                    for (c.lineWidth = l.lineThickness; h < p.length; h++)
                        if (k = p[h].x.getTime ? p[h].x.getTime() : p[h].x, !(k < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if (null !== p[h].y && p[h].y.length && "number" === typeof p[h].y[0] && "number" === typeof p[h].y[1]) {
                                ...
                                m = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (p[h].y[1] - a.axisY.conversionParameters.minimum) +
                                    0.5 << 0;
                                ...
                                if (0 !== p[h].markerSize && (0 < p[h].markerSize || 0 < l.markerSize)) {
                                    var u = l.getMarkerProperties(h, k, n, c);
                                    e.push(u);
                                    var t = A(s);
                                    v && e.push({
                                        x: k,
                                    ...
                                    u = l.getMarkerProperties(h, k, m, c);
                                    e.push(u);
                                    t = A(s);
                                    v && e.push({
                                        x: k,
                                ...
                                if (p[h].indexLabel || l.indexLabel) this._indexLabels.push({
                                    chartType: "splineArea",
                                    dataPoint: p[h],
                                    dataSeries: l,
                                    indexKeyword: 0,
    ...
    w.prototype.renderPie = function (a) {
        ...
        function c() {
            if (n &&
                ...
                for (var c = 0, d = 0, e = 0, g = 0, b = 0; b < m.length; b++) {
                    ...
                    t.push(h);
                    var p = f.indexLabel ? f.indexLabel : n.indexLabel ? n.indexLabel : f.label ? f.label : n.label ? n.label : "";
                    ...
                    h.y = f.y;
                    h.radius = z;
                    h.indexLabelText = k.replaceKeywordsWithValue(p, f, n, b);
                    ...
                    h.indexLabelMaxWidth = f.indexLabelMaxWidth ? f.indexLabelMaxWidth : n.indexLabelMaxWidth ? n.indexLabelMaxWidth : 0.33 * q.width;
        ...
        function d() {
            ...
            if (null !== u && u.frame < u.maxFrames) {
                0 === u.frame && (u.prevMaxAngle = t[0].startAngle);
                a.clearRect(q.x1, q.y1, q.width, q.height);
                a.fillStyle = k.backgroundColor;
                a.fillRect(q.x1, q.y1, q.width,
                    q.height);
                for (var a = u.prevMaxAngle + 2 * Math.PI / u.maxFrames, c = 0; c < m.length; c++) {
                    var g = 0 === c ? t[c].startAngle : f,
                        f = g + (t[c].endAngle - t[c].startAngle),
                        h = !1;
                    f > a && (f = a, h = !0);
                ...
                u.frame++;
                u.prevMaxAngle = a;
                u.frame < u.maxFrames ? k.animationRequestId = k.requestAnimFrame.call(window, d) : (b(v ? 15 : 4), e())
            }
        }
        ...
        function e() {
            ...
            if (null !== u && u.frame < u.maxFrames) {
                ...
                a.fillStyle = k.backgroundColor;
                a.fillRect(q.x1, q.y1, q.width, q.height);
                for (a = 0; a < m.length; a++) {
                    var b = t[a].startAngle,
                        c = t[a].endAngle;
                    if (c > b) {
                        var d = 0.07 * z * Math.cos(t[a].midAngle),
                            f = 0.07 * z * Math.sin(t[a].midAngle),
                            g = !1;
                        if (m[a].exploded) {
                            if (Math.abs(t[a].center.x - (G.x + d)) > Math.abs(0.5 * d / u.maxFrames) || Math.abs(t[a].center.y - (G.y + f)) > Math.abs(0.5 * f / u.maxFrames)) t[a].center.x += d / u.maxFrames, t[a].center.y += f / u.maxFrames, g = !0
                        } else if (Math.abs(t[a].center.x - G.x) > Math.abs(0.5 * d / u.maxFrames) ||
                            Math.abs(t[a].center.y - G.y) > Math.abs(0.5 * f / u.maxFrames)) t[a].center.x -= d / u.maxFrames, t[a].center.y -= f / u.maxFrames, g = !0;
                ...
                for (b = b = 0; b < m.length; b++) c = t[b], c.indexLabelText &&
                    (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "outside" === n.indexLabelPlacement ? -(c.indexLabelTextBlock.width + r) : -c.indexLabelTextBlock.width / 2 : "outside" === n.indexLabelPlacement ? r : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, "outside" === c.indexLabelPlacement && (d = c.center.x + z * Math.cos(c.midAngle), f = c.center.y + z * Math.sin(c.midAngle),
                        a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness, a.beginPath(), a.moveTo(d, f), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -r : r), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
                u.frame < u.maxFrames && (k.animationRequestId = k.requestAnimFrame.call(window, e))
            }
        }
        ...
        function f(a, b) {
            var c = a.indexLabelTextBlock.x,
                ...
                e = a.indexLabelTextBlock.y + a.indexLabelTextBlock.height /
                2,
                f = b.indexLabelTextBlock.y - b.indexLabelTextBlock.height / 2,
                g = b.indexLabelTextBlock.x + b.indexLabelTextBlock.width,
                k = b.indexLabelTextBlock.y + b.indexLabelTextBlock.height / 2;
            return a.indexLabelTextBlock.x + a.indexLabelTextBlock.width < b.indexLabelTextBlock.x - r || c > g + r || d > k + r || e < f - r ? !1 : !0
        }
        ...
        function l(a) {
            for (var b = null, c = 1; c < m.length; c++)
                if (b = (a + c + t.length) % t.length, t[b].hemisphere !== t[a].hemisphere) {
                    b = null;
                    break
                } else if (t[b].indexLabelText && b !== a && (0 > g(t[b], t[a]) || ("right" === t[a].hemisphere ? t[b].indexLabelTextBlock.y >= t[a].indexLabelTextBlock.y : t[b].indexLabelTextBlock.y <= t[a].indexLabelTextBlock.y))) break;
            else b = null;
            return b
        }
        ...
        function p(a, b) {
            ...
            if (0 <= a && a <
                ...
                var k = b,
                    ...
                    n = 0,
                    n = h = h = 0;
                0 > k ? f.indexLabelTextBlock.y - f.indexLabelTextBlock.height / 2 > d && f.indexLabelTextBlock.y - f.indexLabelTextBlock.height / 2 + k < d && (k = -(d - (f.indexLabelTextBlock.y - f.indexLabelTextBlock.height / 2 + k))) : f.indexLabelTextBlock.y + f.indexLabelTextBlock.height / 2 < d && f.indexLabelTextBlock.y + f.indexLabelTextBlock.height / 2 + k > e && (k = f.indexLabelTextBlock.y + f.indexLabelTextBlock.height / 2 + k - e);
                k = f.indexLabelTextBlock.y +
                    k;
                d = 0;
                d = "right" === f.hemisphere ? G.x + Math.sqrt(Math.pow(F, 2) - Math.pow(k - G.y, 2)) : G.x - Math.sqrt(Math.pow(F, 2) - Math.pow(k - G.y, 2));
                n = G.x + z * Math.cos(f.midAngle);
                h = G.y + z * Math.sin(f.midAngle);
                h = Math.sqrt(Math.pow(d - n, 2) + Math.pow(k - h, 2));
                n = Math.acos(z / F);
                h = Math.acos((F * F + z * z - h * h) / (2 * z * F));
                k = h < n ? k - f.indexLabelTextBlock.y : 0;
                d = null;
                for (e = 1; e < m.length; e++)
                    ...
                    t[a]) || ("right" === t[a].hemisphere ? t[d].indexLabelTextBlock.y <= t[a].indexLabelTextBlock.y : t[d].indexLabelTextBlock.y >= t[a].indexLabelTextBlock.y))) break;
                else d = null;
                n = d;
                h = l(a);
                e = d = 0;
                0 > k ? (e = "right" === f.hemisphere ? n : h, c = k, null !== e && (n = -k, k = f.indexLabelTextBlock.y - f.indexLabelTextBlock.height / 2 - (t[e].indexLabelTextBlock.y + t[e].indexLabelTextBlock.height / 2), k - n < w && (d = -n, s++, e = p(e, d), +e.toFixed(B) > +d.toFixed(B) && (c = k > w ? -(k - w) : -(n - (e - d)))))) : 0 < k && (e = "right" === f.hemisphere ? h : n, c = k, null !== e && (n = k, k = t[e].indexLabelTextBlock.y -
                    t[e].indexLabelTextBlock.height / 2 - (f.indexLabelTextBlock.y + f.indexLabelTextBlock.height / 2), k - n < w && (d = n, s++, e = p(e, d), +e.toFixed(B) < +d.toFixed(B) && (c = k > w ? k - w : n - (d - e)))));
                c && (k = f.indexLabelTextBlock.y + c, d = 0, d = "right" === f.hemisphere ? G.x + Math.sqrt(Math.pow(F, 2) - Math.pow(k - G.y, 2)) : G.x - Math.sqrt(Math.pow(F, 2) - Math.pow(k - G.y, 2)), f.midAngle > Math.PI / 2 - y && f.midAngle < Math.PI / 2 + y ? (e = (a - 1 + t.length) % t.length, e = t[e], n = t[(a + 1 + t.length) % t.length], "left" === f.hemisphere && "right" === e.hemisphere && d > e.indexLabelTextBlock.x ?
        ...
        function h() {
            ...
            for (var c = 0, e = a = 0, a = 0; 10 > a && (1 > a || 0 < e); a++) {
                z -= e;
                e = 0;
                if ("outside" === n.indexLabelPlacement) {
                    F = z * A;
                    ...
                    for (var s, u,
                        ...
                        if (null !== y) {
                            ...
                            var C = 0,
                                C = g(s, u) - w;
                            if (0 > C) {
                                for (var D = u = s = 0; D < m.length; D++) D !== c && t[D].hemisphere === h.hemisphere && (t[D].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? s++ : u++);
                                D = C / (s + u || 1) * u;
                                s = -1 * (C - D);
                                var H = u = 0;
                                "right" === h.hemisphere ? (u = p(c, D), s = -1 * (C - u), H = p(y, s), +H.toFixed(B) < +s.toFixed(B) && +u.toFixed(B) <= +D.toFixed(B) && p(c, -(s - H))) : (u = p(y, D), s = -1 * (C - u), H = p(c, s), +H.toFixed(B) < +s.toFixed(B) && +u.toFixed(B) <= +D.toFixed(B) && p(y, -(s - H)))
                            }
                        }
                    }
                } else
                ...
                for (c = 0; c < m.length; c++) h = t[c], C = h.indexLabelTextBlock.measureText(), 0 !== C.height && 0 !== C.width && (C = C = 0, "right" === h.hemisphere ? (C = q.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + r), C *= -1) : C = q.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - r), 0 < C && (Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - G.y) < z || Math.abs(h.indexLabelTextBlock.y +
                ...
                for (D = H = 0; D < m.length; D++)
                    if (s = t[D], s.indexLabelText) {
                        var I = l(D);
                        null !== I && (u = t[I], C = 0, C = g(s, u), 0 > C && f(s, u) ? (0 > h && (h = D), I !== h && (y = I), H += -C) : 0 < H && (c(H, h, y), y = h = -1, H = 0))
                    }
                0 < H && c(H, h, y)
            }
            b(k.animationEnabled && 0 === k.renderCount ? v ? 60 : 30 : 1);
            d()
        }
        var k = this;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var n = this.data[a.dataSeriesIndexes[0]],
                ...
                z = "inside" === n.indexLabelPlacement ? 0.95 * Math.min(q.width, q.height) / 2 : 0.8 * Math.min(q.width, q.height) / 2,
                F = z * A;
            this.pieDoughnutClickHandler = function (a) {
                u.frame === u.maxFrames && (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, b(v ? 15 : 4), 1 < this.dataPoints.length && e())
            };
            c();
            h()
        }
        ...
        function () {
            if (this.text) {
                ...
                "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (c = this.margin, l = "top") : "bottom" === this.verticalAlign &&
                    ...
                    c = a.y1 + this.margin + (e / 2 - p.width / 2), d = 90, l = "right", this.width = p.height, this.height = p.width) : "center" === this.horizontalAlign && (c = a.y1 + (a.height / 2 - p.height / 2), b = a.x1 + (a.width / 2 - p.width / 2), l = "center", this.width = p.width, this.height = p.height), g = "center");
                f.x = b;
                f.y = c;
                f.angle = d;
                f.horizontalAlign = g;
    ...
    ga.prototype.render = function () {
        ...
        for (var p = 0; p < this.dataSeries.length; p++) {
            var h = this.dataSeries[p],
                k = h.legendMarkerType ? h.legendMarkerType : "line" !== h.type && "stepLine" !==
                h.type && "spline" !== h.type && "scatter" !== h.type && "bubble" !== h.type || !h.markerType ? O.getDefaultLegendMarker(h.type) : h.markerType,
                n = h.legendText ? h.legendText : h.name,
        ...
        if (0 < g.length) {
            ...
            for (p = q = 0; p < g.length; p++) {
                ...
                if ("horizontal" === this.orientation) {
                    ...
                    items: [],
                    width: 0
                }, l.push(h), this.height = l.length * this.lineHeight) : (h = l[q], q = (q + 1) % l.length), k.textBlock = new H(this.ctx, {
                    x: 0,
                    y: 0,
                    maxWidth: e,
        ...
        this.items = g;
        for (p = 0; p < this.items.length; p++) k = g[p], k.id = ++this.chart._eventManager.lastObjectId,
        ...
        for (p = 0; p < l.length; p++)
            for (h = l[p], a = 0; a < h.items.length; a++) {
                k = h.items[a];
        ...
        for (;;) {
            ...
            if (0 <= f && f < this.dataPoints.length) {
                ...
                if (m) {
                    ...
                    case "splineArea":
                    case "scatter":
                        var s = R("markerSize", r, this) || 4,
                            u = c ? 20 : s,
                            q = Math.sqrt(Math.pow(m.x1 - a, 2) + Math.pow(m.y1 - b, 2));
                        q <= u && d.push({
                            dataPoint: r,
                            dataPointIndex: f,
                            dataSeries: this,
                    ...
                    case "rangeSplineArea":
                        ...
                        u = c ? 20 : s;
                        q = Math.min(Math.sqrt(Math.pow(m.x1 - a, 2) + Math.pow(m.y1 - b, 2)), Math.sqrt(Math.pow(m.x1 - a, 2) + Math.pow(m.y2 - b, 2)));
                        q <= u && d.push({
                            dataPoint: r,
                            dataPointIndex: f,
                            dataSeries: this,
                    ...
                    case "doughnut":
                        ...
                        u = "doughnut" === this.type ?
                            0.6 * m.radius : 0;
                        q = Math.sqrt(Math.pow(s.x - a, 2) + Math.pow(s.y - b, 2));
                        q < m.radius && q > u && (q = Math.atan2(b - s.y, a - s.x), 0 > q && (q += 2 * Math.PI), q = (180 * (q / Math.PI) % 360 + 360) % 360, s = (180 * (m.startAngle / Math.PI) % 360 + 360) % 360, u = (180 * (m.endAngle / Math.PI) % 360 + 360) % 360, 0 === u && 1 < m.endAngle && (u = 360), s > u && (u += 360, q < s && (q += 360)), q > s && q < u && (d.push({
                            dataPoint: r,
                            dataPointIndex: f,
                            dataSeries: this,
                            distance: 0
    ...
    z.prototype.createLabels = function () {
        ...
        else if ("left" === this._position || "right" === this._position) b = this.lineCoordinates.height / Math.abs(this.maximum -
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)
            ...
            for (b = this.intervalStartPosition; b <= c; b += this.interval) a = "axisX" === this.type && this.labels[b] ? this.labels[b] : W(b, this.valueFormatString, this.chart._cultureInfo), a = new H(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: d,
                maxHeight: e,
    ...
    z.setLayoutAndRender = function (a, b, c, d, e) {
        ...
        if ("normal" === d) {
            ...
            var m = Math.ceil(b ? b.createLabelsAndCalculateHeight() : 0),
                r = Math.ceil(c ? c.createLabelsAndCalculateHeight() : 0);
    ...
    z.prototype.renderInterlacedColors = function () {
        ...
        if (("bottom" === this._position || "top" === this._position) && this.interlacedColor)
            for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++) this._labels[e].stripLine || (b ? (b = this.getPixelCoordinatesOnAxis(this._labels[e].position), c = e + 1 >= this._labels.length ? this.getPixelCoordinatesOnAxis(this.maximum) : this.getPixelCoordinatesOnAxis(this._labels[e + 1].position),
            ...
            for (var b = this.chart.plotArea.ctx, c = 0, c = 0; c < this.stripLines.length; c++) {
                ...
                if (d._thicknessType === a && ("pixel" !== a || !(d.value < this.minimum || d.value > this.maximum))) {
                    var e = this.getPixelCoordinatesOnAxis(d.value),
                        f = Math.abs("pixel" === a ? d.thickness : this.conversionParameters.pixelPerUnit * d.thickness);
                    if (!(0 >= f)) {
                        ...
                        var g, l, p, h;
                        b.lineWidth = f;
                        if ("bottom" === this._position || "top" === this._position) g = l = 1 === b.lineWidth % 2 ? (e.x << 0) + 0.5 : e.x << 0, p = this.chart.plotArea.y1, h = this.chart.plotArea.y2;
                        else if ("left" === this._position || "right" === this._position) p = h = 1 === b.lineWidth % 2 ? (e.y << 0) + 0.5 : e.y << 0, g = this.chart.plotArea.x1, l = this.chart.plotArea.x2;
                        b.moveTo(g, p);
                        b.lineTo(l, h);
                        b.stroke()
                    }
    ...
    z.prototype.renderGrid = function () {
        if (this.gridThickness && 0 < this.gridThickness) {
            ...
            if ("bottom" === this._position || "top" === this._position)
                ...
                for (var d = 0; d < this._labels.length && !this._labels[d].stripLine; d++) this._labels[d].position <
    ...
    z.prototype.calculateAxisParameters = function () {
        ...
        var a = "axisX" === this.type ? 500 > this.maxWidth ? 8 : Math.max(6, Math.floor(this.maxWidth / 62)) : Math.floor(this.maxWidth / 40),
            b, c, d, e;
        "axisX" === this.type ? (b = null !== this.sessionVariables.internalMinimum ? this.sessionVariables.internalMinimum : this.dataInfo.viewPortMin, c = null !== this.sessionVariables.internalMaximum ? this.sessionVariables.internalMaximum : this.dataInfo.viewPortMax, 0 === c - b && (c += 0.4, b -= 0.4), d = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff :
        ...
        "axisX" === this.type && (this._absoluteMinimum = this._options && "undefined" !== typeof this._options.minimum ? this._options.minimum : this.dataInfo.min - d / 2, this._absoluteMaximum =
            this._options && "undefined" !== typeof this._options.maximum ? this._options.maximum : this.dataInfo.max + d / 2);
    ...
    z.getNiceNumber = function (a, b) {
        var c = Math.floor(Math.log(a) / Math.LN10),
            d = a / Math.pow(10, c);
        return (b ? 1.5 > d ? 1 : 3 > d ? 2 : 7 > d ? 5 : 10 : 1 >= d ? 1 : 2 >= d ? 2 : 5 >= d ? 5 : 10) * Math.pow(10, c)
    };
    z.prototype.getLabelStartPoint =
        function () {
            var a = X(this.interval, this.intervalType),
    ...
    M.prototype._updateToolTip = function (a, b) {
        if (this.enabled) {
            ...
            if (this.shared && "none" !== this.chart.plotInfo.axisPlacement) {
                f = "xySwapped" === this.chart.plotInfo.axisPlacement ? (this.chart.axisX.maximum - this.chart.axisX.minimum) / this.chart.axisX.lineCoordinates.height *
                    (this.chart.axisX.lineCoordinates.y2 - b) + this.chart.axisX.minimum : (this.chart.axisX.maximum - this.chart.axisX.minimum) / this.chart.axisX.lineCoordinates.width * (a - this.chart.axisX.lineCoordinates.x1) + this.chart.axisX.minimum;
                c = [];
                ...
                f = c[0];
                for (d = 0; d < c.length; d++) c[d].dataPoint.x.valueOf() ===
                ...
                else if ("line" === d.type || "stepLine" === d.type || "spline" === d.type || "area" === d.type || "stepArea" === d.type || "splineArea" === d.type || "stackedArea" === d.type || "stackedArea100" === d.type || "rangeArea" === d.type || "rangeSplineArea" === d.type ||
                    "candlestick" === d.type || "ohlc" === d.type) f = (this.chart.axisX.maximum - this.chart.axisX.minimum) / this.chart.axisX.lineCoordinates.width * (a - this.chart.axisX.lineCoordinates.x1) + this.chart.axisX.minimum.valueOf(), g = d.getDataPointAtX(f, !0), g.dataSeries = d, this.currentDataPointIndex = g.index, c = g.dataPoint;
                else return;
            ...
            if (0 < e.length)
                if (this.highlightObjects(e), f = "", f = this.getToolTipInnerHTML({
                    ...
                    f = !1;
                    "none" ===
                        this.container.style.display && (f = !0, this.container.style.display = "block");
                    try {
                    ...
                    "pie" === e[0].dataSeries.type || "doughnut" === e[0].dataSeries.type || "funnel" === e[0].dataSeries.type || "bar" === e[0].dataSeries.type ||
                    ...
                    toolTipLeft + this.container.clientWidth >
                        this.chart._container.clientWidth && (toolTipLeft = Math.max(0, this.chart._container.clientWidth - this.container.clientWidth));
                    toolTipLeft += "px";
                    e = 1 !== e.length || this.shared || "line" !== e[0].dataSeries.type && "stepLine" !== e[0].dataSeries.type && "spline" !== e[0].dataSeries.type && "area" !== e[0].dataSeries.type && "stepArea" !== e[0].dataSeries.type && "splineArea" !== e[0].dataSeries.type && "stackedArea" !== e[0].dataSeries.type && "stackedArea100" !== e[0].dataSeries.type ? "bar" === e[0].dataSeries.type || "rangeBar" === e[0].dataSeries.type ||
        ...
        if (this.enabled) {
            ...
            for (var d = 0, c = 0; c < a.length; c++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    ...
                    if ("line" === d.type || "stepLine" === d.type || "spline" === d.type || "scatter" === d.type || "area" === d.type || "stepArea" === d.type || "splineArea" === d.type || "stackedArea" === d.type || "stackedArea100" === d.type || "rangeArea" === d.type || "rangeSplineArea" === d.type) {
                    ...
                    } else "bubble" === d.type ? (g = d.getMarkerProperties(f, e.x1, e.y1, this.chart.overlaidCanvasCtx), g.size = e.size, g.color =
                        ...
                        d, e.y3), b.stroke(), b.beginPath(), b.moveTo(e.x3, e.y1), b.lineTo(e.x1, e.y1), b.stroke(), b.beginPath(), b.moveTo(e.x3, e.y4), b.lineTo(e.x2, e.y4), b.stroke(), b.globalAlpha = 1)
                }
            }
            b.globalAlpha = 1;
            b.restore()
    ...
    M.prototype.getToolTipInnerHTML = function (a) {
        ...
        if (g && this.content && "function" === typeof this.content) b = this.content({
            ...
            for (var p =
                "", l = 0; l < a.length; l++)
                if (c = a[l].dataSeries, d = a[l].dataPoint, e = a[l].index, f = "", 0 === l && (g && !this.content) && (p += "undefined" !== typeof this.chart.axisX.labels[d.x] ? this.chart.axisX.labels[d.x] : "{x}", p += "</br>", p = this.chart.replaceKeywordsWithValue(p, d, c, e)), null !== d.toolTipContent && ("undefined" !== typeof d.toolTipContent || null !== c._options.toolTipContent)) {
                    if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" ===
                        c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type) f += d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>{name}:</span>&nbsp;&nbsp;{y}";
                    else if ("bubble" === c.type) f += d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !==
    ...
    w.prototype.replaceKeywordsWithValue = function (a, b, c, d, e) {
        ...
        if ((0 <= c.type.indexOf("stacked") || "pie" === c.type ||
            ...
            var g = "#percent",
                l = "#total";
            if (0 <= c.type.indexOf("stacked")) l = 0, 0 < c.plotUnit.yTotals.length && (l = c.plotUnit.yTotals[b.x], g = isNaN(b.y) ? 0 : 100 * (b.y / l));
            ...
            do a = a.replace("#percent", W(g, "#,##0.##")), a = a.replace("#total", W(l, c.yValueFormatString ? c.yValueFormatString : "#,##0.########"));
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
            ...
            return "x" === a ? f.axisX && "dateTime" === f.plotInfo.axisXValueType ? xa(k, b.xValueFormatString ? b.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : f.axisX && f.axisX.valueFormatString ? f.axisX.valueFormatString : "DD MMM YY", f._cultureInfo) : W(k, b.xValueFormatString ? b.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : "#,##0.########", f._cultureInfo) : "y" === a ? W(k, b.yValueFormatString ? b.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : "#,##0.########",
                f._cultureInfo) : "z" === a ? W(k, b.zValueFormatString ? b.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : "#,##0.########", f._cultureInfo) : k
        })
    };
        ...
        function (a) {
            if ("mousemove" === a.type || "click" === a.type) {
                ...
                for (c = 0; c < this.mouseoveredObjectMaps.length; c++) {
                    ...
                    f ?
                        this.fireEvent(this.mouseoveredObjectMaps[c], "mouseout", a) : e.push(this.mouseoveredObjectMaps[c])
                }
            ...
            drawMarker: function (a, b, c, d, e, f, g, l) {
                if (c) {
                    ...
                    "circle" === d ? (c.moveTo(a, b), c.beginPath(), c.arc(a, b, e / 2, 0, 2 * Math.PI, !1), f && c.fill(), l && (g ? c.stroke() : (p = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "black", c.stroke(), c.globalAlpha = p))) : "square" === d ? (c.beginPath(), c.rect(a - e / 2, b - e / 2, e, e), f && c.fill(), l && (g ? c.stroke() : (p = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "black", c.stroke(), c.globalAlpha = p))) : "triangle" === d ? (c.beginPath(), c.moveTo(a - e / 2, b + e / 2), c.lineTo(a + e / 2, b + e / 2), c.lineTo(a,
                        b - e / 2), c.closePath(), f && c.fill(), l && (g ? c.stroke() : (p = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "black", c.stroke(), c.globalAlpha = p)), c.beginPath()) : "cross" === d && (c.strokeStyle = f, c.lineWidth = e / 4, c.beginPath(), c.moveTo(a - e / 2, b - e / 2), c.lineTo(a + e / 2, b + e / 2), c.stroke(), c.moveTo(a + e / 2, b - e / 2), c.lineTo(a - e / 2, b + e / 2), c.stroke())
                }
            },
